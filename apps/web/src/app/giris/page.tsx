  ...
  return (
    <div className="mx-auto max-w-md px-4 py-20">
      <div className="card p-8">
        ...
        <p className="text-sm text-[var(--muted)] text-center mt-1">{t("loginDesc")}</p>
        ...
        <p className="mt-4 text-center text-sm text-[var(--muted)]">
          {t("noAccount")}{" "}
          <Link href="/kayit" className="text-brand-600 hover:underline font-medium">{t("registerBtn")}</Link>
        </p>
      </div>
    </div>
  );
